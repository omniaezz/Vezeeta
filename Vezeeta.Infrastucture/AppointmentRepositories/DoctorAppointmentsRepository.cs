...
{
    public class DoctorAppointmentsRepository : Repository<DoctorAppointments, int>, IDoctorAppointmentsRepository
    {
        private readonly VezeetaContext _vezeetaContext;

        public DoctorAppointmentsRepository(VezeetaContext vezeetaContext) : base(vezeetaContext)
        {
            _vezeetaContext = vezeetaContext;
        }

        public Task<IQueryable<Appointment>> GetAppointmentsByDoctorId(int doctorId)
        {
            return Task.FromResult( from da in _vezeetaContext.DoctorAppointments
