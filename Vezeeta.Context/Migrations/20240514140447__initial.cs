        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CountriesImagesPath = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CountriesImages_Countries_CountriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkingPlaces_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Visits_UserAppointments_UserAppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClinicImages_WorkingPlaces_WorkingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClinicImages_WorkingId",
                table: "ClinicImages",
                column: "WorkingId");

            migrationBuilder.CreateIndex(
                name: "IX_CountriesImages_CountriesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAppointments_DoctorId",
                table: "UserAppointments",
                column: "DoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_UserAppointmentId",
                table: "Visits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingPlaces_DoctorId",
                table: "WorkingPlaces",
                column: "DoctorId");
        }
